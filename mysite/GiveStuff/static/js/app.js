        ...
        constructor(form) {
            ...
            for (let i = 0; i < listOfCategories.length; ++i) {
                ...
                obecnyGuzik.addEventListener('change', function (e) {
                        ...
                        if (e.target.checked) {
                            document.formStep.CategoriIDs.push(a)
                        } else {
                            let indeks = document.formStep.CategoriIDs.indexOf(a)
                            document.formStep.CategoriIDs.splice(indeks, 1)
                        }
                        console.log(document.formStep.CategoriIDs)
                ...
                btn.addEventListener("click", e => {
                    ...
                    if (this.currentStep === 2) {
                        $.ajax({
                            ...
                            url: '/my_def_in_view',
                            data: {
                                "result": document.formStep.CategoriIDs,
                            },
                            dataType: "json",
